...
namespace WinFromsINEC
{
    public partial class frmINEC : Form
    {
        ...
        Thread Male_Age_Thread; // Hilo para generar los datos de los hombres
        Thread Female_Age_Thread; // Hilo para generar los datos de las muejeres
        Thread Scholarship_Thread; // Hilo para generar los datos de la escolaridad
        #endregion
        ...
        private void btnLoadFile_Click(object sender, EventArgs e)
        {
            ...
            //Del archivo de texto obtiene la información
            ReadFile();
            ...
            //Se invoca la acción dentro del parentesis para que se ejecute por aparte y otros procesos no agarren su espacio
        ...
        public void ReadFile()
        {
            ...
            //Se almacena el largo del archivo
            ...
            try
            {
                ...
                //Lee la primer linea del archivo de texto
                ...
                //Mientras haya algun valor en la liena
                while (line != null)
                {
                    ...
                    line = reader.ReadLine();
                    //Avanza unnpaso en la barra de progreso
                    prgAge.PerformStep();
                }
        ...
        {
            //Se inicializa la variable del arreglo para almacenar los datos
